...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0d1117] text-[#c9d1d9] font-sans p-4">
      <div className="w-full max-w-[440px] flex flex-col items-center">
        ...
        <div className="w-full bg-[#161b22] border border-[#30363d] rounded-lg shadow-md p-6">
          ...
          <form onSubmit={handleAuthSubmit} className="space-y-4">
            {activeTab === 'register' && (
              <div>
                <label className="block text-sm font-medium mb-1.5 text-white">Username</label>
                <input
                  type="text"
                  required
                  ...
                  className="w-full px-3 py-2 bg-[#0d1117] border border-[#30363d] rounded-md focus:outline-none focus:border-[#58a6ff] text-sm text-white focus:ring-1 focus:ring-[#58a6ff]"
                />
              </div>
            )}

            <div>
              <label className="block text-sm font-medium mb-1.5 text-white">Email address</label>
              <input
                type="email"
                required
            ...
            <div>
              <label className="block text-sm font-medium mb-1.5 text-white">Password</label>
              <input
                type="password"
                required
          ...
          <div className="mt-6 text-center text-sm border-t border-[#30363d] pt-4">
            {activeTab === 'login' ? (
              <p className="text-[#8b949e]">
                ...
                <button
                  ...
                  className="text-[#58a6ff] hover:underline cursor-pointer bg-transparent border-0"
                >
                  Create an account
                </button>
              </p>
